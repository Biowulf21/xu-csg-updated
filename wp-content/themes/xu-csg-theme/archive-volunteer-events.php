...
<header class="custom-banner" style="margin-bottom: 1em;">
 <img src="https://xu-csg.org/wp-content/uploads/2023/05/CSG-WEBSITE-BANNER-VOLUNTEERS-1.png" alt="Banner image" style="width: 100%; height: auto;">
</header>
  <div id="form-div">
    <div id="form-div">
  ...
  <strong>
    <h1 id="post-type-title">Volunteering Events</h1>
  </strong>
  <section>
 ...
 <?php endwhile;?>
      <?php else : ?>
        <h4>No Volunteer Events to show</h1>
      <?php endif; ?>
    </div>
